...
export class QueryParsingUtils {
    ...
    public static parseLimitStart(limit: string | string[], start: string | string[]): [number, number] {
    ...
    public static parseSort(pRawSort: string | string[]): [string, number][] | undefined {
        if (pRawSort) {
            let rawSort = '';
    ...
    public static parseQuery(pQueryString: string | string[], allowFields?: string[]) {
        if (!pQueryString) {
            return {};
        }
        let queryString = "";
        ...
        try {
            ...
            Logger.info(`Can't parse query ${queryString}, error detail: ${unexpectedErr}`)
            return {};
        }
    }

    public static addExtraQuery(query: string | string[], extraQuery: string[]): string | string[] {
